...
const (
	...
	MODEL                    string = "deepseek-r1-distill-qwen-32b"
	...
	URL_AGENT_ONE			 string = "http://localhost:1234/v1/chat/completions"
	URL_AGENT_TWO			 string = "http://localhost:1234/v1/chat/completions"
	...
	REQUEST_TIMEOUT_INTERVAL int    = 1200  // s
	WORKERS					 int 	= 10 // max goroutines, because i'm running locally
